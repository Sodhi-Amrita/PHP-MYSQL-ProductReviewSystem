...
<section id="feedback">
            <h3>Edit your review based upon Product Id!</h3>
            <form method='post' action=''>
            ...
            <input type="radio" name="options" id="1" value="Very Poor">Very Poor
            <input type="radio" name="options" id="2" value="Poor">Poor
            <input type="radio" name="options" id="3" value="Average">Average
            <input type="radio" name="options" id="4" value="Good">Good
            <input type="radio" name="options" id="5" value="Excellent">Excellent <br><br>
            <label class="desc">Comments</label>
            <div class="descc">
                <input type="text" name="review" id="description2" placeholder="Type your comment here..."><br><br>
            </div>
...
if ( empty($id)|| empty($name) || empty($rating) || empty($review_text)) {
    // Handle validation errors
    echo '<script>alert("All fields are required")</script>';
} else {

   $sql = "UPDATE review 	
SET  product_name = '$name', rating = '$rating', comment = '$review_text'
WHERE id = '$id'";
   ...
   // $sql = "INSERT INTO review (product_name, rating, comment) VALUES ('$name', '$rating', '$review_text')";
    ...
    {
        echo '<script>alert("Review Editted successfully")</script>';
    } else 
    {
        echo '<script>alert("Error Editing Review.")</script>';
    }
}
}
